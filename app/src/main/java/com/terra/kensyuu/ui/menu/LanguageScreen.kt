...
fun LanguageScreen(onBack: () -> Unit) {
    ...
    val systemTag = LocalConfiguration.current.locales[0].toLanguageTag()
    val current = AppLanguage.resolveEffective(settings.languageTagOverride, systemTag)
                ...
                Row(
                    modifier = Modifier
                        ...
                        .selectable(
                            ...
                            onClick = {
                                scope.launch { app.settingsRepository.setLanguageTag(language.tag) }
